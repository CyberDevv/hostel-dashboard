...
const CardSection = () => {
    return(
        <div className="flex w-full md:[w-49%] rounded-xl">
            <div className="w-full">
                <h3 className="text-primary-Default">Settings</h3>
                <div className="md:w-full sm:w-10/12 lg:py-4 lg:px-5 my-6 px-3 py-3 flex flex-col text-white gap-y-16 bg-primary-Default rounded-xl">
                ...
                <div className="lg:p-5 px-3 py-5 bg-white rounded-lg">
                    <div>
